...
const proxy = program
  .command("proxy")
  .description(
    "Loopback model proxy: pass Anthropic Messages and OpenAI-compatible chat through to the real providers, record bounded usage, and reuse recent local tool work when the same project, paths, and tool match",
  )
