...
const HELM_CODEX_HOOKS = {
  SessionStart: { command: HELM_CODEX_INJECT_COMMAND, statusMessage: "Helm", timeout: 3 },
  UserPromptSubmit: { command: HELM_CODEX_INJECT_COMMAND, statusMessage: "Helm", timeout: 3 },
