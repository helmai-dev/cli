...
export async function pollForRuns(
  ...
  return request<PollForRunsResponse>(`/admiral/machines/${machineId}/poll`, {
    method: "POST",
  });
}

export async function acknowledgeMachineCommands(
  machineId: number,
  commandIds: string[],
): Promise<{ acknowledged: number }> {
  return request<{ acknowledged: number }>(
    `/admiral/machines/${machineId}/commands/ack`,
    {
      method: "POST",
...
export async function updateRunStatus(
  ...
  return request<UpdateRunStatusResponse>(`/admiral/runs/${runId}/status`, {
    method: "PATCH",
    body: JSON.stringify({
      status,
...
export async function storeRunEvent(
  ...
  return request<StoreRunEventResponse>(`/admiral/runs/${runId}/events`, {
    method: "POST",
    body: JSON.stringify({
